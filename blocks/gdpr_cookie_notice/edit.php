...
<div class="tab-content">
    <div class="ccm-tab-content tab-pane active" role="tabpanel" id="<?= $tabsPrefix ?>gdpr_cookie_notice-edit-basics">
    ...
    <div class="ccm-tab-content tab-pane" role="tabpanel" id="<?= $tabsPrefix ?>gdpr_cookie_notice-edit-colors">
        <div class="form-group">
    ...
    <div class="ccm-tab-content tab-pane" role="tabpanel" id="<?= $tabsPrefix ?>gdpr_cookie_notice-edit-actions">
        <div class="form-group">
            <div class="checkbox">
                <label>
    ...
    <div class="ccm-tab-content tab-pane" role="tabpanel" id="<?= $tabsPrefix ?>gdpr_cookie_notice-edit-advanced">
        <div class="form-group">
    ...
    <div class="ccm-tab-content tab-pane" role="tabpanel" id="<?= $tabsPrefix ?>gdpr_cookie_notice-edit-preview">
    </div>
</div>

<script>
$(function() {
var $preview = $(<?= json_encode("#{$tabsPrefix}gdpr_cookie_notice-edit-preview") ?>),
...
$('a[data-tab="gdpr_cookie_notice-edit-preview"],#gdpr_cookie_notice-edit-preview-tab').on('click', function(e) {
    e.preventDefault();
    var send = {
